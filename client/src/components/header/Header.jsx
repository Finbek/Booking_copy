...
export const Header = ({type}) => {
  ...
  const handleOption=(option, operation)=>{
    setOptions(prev=>{
      return {
      ...prev,[option]: operation==='i'? options[option]+1 : options[option]-1
    }})
  }
      ...
      <div className = {type!=='list' ?"headerContainer": "headerContainer listMode"}>
        ...
        { type!=='list' &&
          <>
            ...
            <p className="headerDesc">Get rewarded for your traverls - unlock instant savings of 10% or more with a free account</p>
